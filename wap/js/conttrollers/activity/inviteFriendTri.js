    ...
    controllers.controller('inviteFriendTri', function ($scope, $filter, $state, $location, resourceService, isWeixin, $timeout, $localStorage,$stateParams,$interval,signWeChatService) {
        ...
        if($stateParams.wap){
            ...
            if ($filter('isRegister')().register==true) {
                ...
                $scope.shareUrl = 'http://wap.huiyuanjinfu.com/friendreg?recommCode=' + $scope.user.member.mobilephone;
            }
            else{
                $scope.ftype = 1;
            }
        ...
        wx.ready(function () {
            wx.onMenuShareTimeline({
                link: 'http://wap.huiyuanjinfu.com/friendreg?wap=true' + linkstr, // 分享链接
                imgUrl: 'http://wap.huiyuanjinfu.com/images/activity/firend/share.png', // 分享图标
                success: function () {
                    alert('分享成功！');
                },
                cancel: function () {
